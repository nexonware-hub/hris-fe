...
const OKRForm = ({state, performanceCycle, cyclePeriod, cyclePeriods, loadGoals, loadingGoals, setShowOKRForm}) => {
  ...
  return (<>
    <Form
      ...
      backgroundColor: '#fff', borderRadius: primaryBorderRadius, margin: '0px', marginBottom: '30px', width: '100%'}}
    >
      ...
      <Button
        style={{position: 'absolute', marginTop: '-56px', marginLeft: '90px'}}
