...
const ApplyLeaveForm = ({reloadApplications, setShowApplyLeaveForm}) => {
  ...
  return (
    <div style={{height: '100%', border: `1px solid ${greyOnWhiteColor}`, borderRadius: primaryBorderRadius}}>
    ...
    <Form
      ...
      style={{ padding: '20px 20px', backgroundColor: 'silverColor', borderRadius: '0px 0px 8px 8px', height: '100%' }}
      form={form}
...
<br/>
      ...
      <Button
        style={{marginLeft: '90px', transform: 'translateY(-55px)'}}
