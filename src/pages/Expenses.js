...
import { CheckCircleOutlined, CloseCircleOutlined, DownloadOutlined, FileDoneOutlined, ImportOutlined, Loading3QuartersOutlined, PlusOutlined, WarningOutlined } from "@ant-design/icons";
    ...
    return (
        <>
            ...
            <div style={{display: 'flex', justifyContent: 'flex-start', alignItems: 'flex-end'}}>
                <img src={addExpense} style={{width: '160px', marginRight: '30px'}} />
                <Button type="primary" onClick={() => setExpenseFormFlyOut(true)}>Add Expense <ImportOutlined /></Button>
            </div>
            <br/>
            <br/>
            <br/>
